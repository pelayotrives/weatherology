  ...
  copyrightYear.innerText = new Date().getFullYear();
    ...
    return (
        <div>
            ...
            <footer className='fixed bottom-0 w-screen p-4 font-onlybody font-regular text-center text-white xsm:text-sm md:text-md lg:text-lg tracking-wide'> Made with 🤍 by&nbsp;
